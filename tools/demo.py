...
## some path
image_file_path = 'data/4.png'
bbox_file_path = 'data/4.txt'

deploy_netpt_path = 'models/SPN160_ResNet/SPN160_ResNet_deploy.netpt'
trained_model_path = 'models/SPN160_ResNet/SPN160_ResNet.caffemodel'
